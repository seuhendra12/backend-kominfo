		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Permission</h1>
				</div>
			</div>
		</div>
					...
					<div class="col-xxl-6">
						<div class="card card-flush h-md-100">
							<div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
								<div class="row">
										...
										<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
												<li class="breadcrumb-item text-muted">
													<p class="text-muted text-hover-primary">Data Permission Kementerian Komunikasi dan Informatika</p>
												</li>
											</ul>
										</div>
									</div>
									<div class="col-6">
										<div class="d-grid d-md-flex justify-content-md-end">
											<a href="/data-permission/create" class="btn btn-sm fw-bold btn-primary">
									...
									<div class="mt-3">
										<div class="row">
											...
											<div class="col-6 d-grid d-md-flex justify-content-md-end mb-3">
												<form class="form" action="/data-permission">
										...
										<table class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="data-permission/{{$permission->id}}/edit" class="btn btn-yellow btn-sm">
															<span>
														...
														<a href="#" class="btn btn-red btn-sm" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-permission-id="{{ $permission->id }}">
															<span>
								...
								<div class="mb-5">
									{{$permissions->appends(['perPage' => $perPage])->links('pagination::bootstrap-5')}}
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="confirm-delete-modal-label">Hapus Permission</h5>
					...
					<div class="modal-body">Apakah kamu yakin ingin menghapus permission ini ?</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
						<form action="{{ url('data-permission', '__permission_id') }}" method="POST" style="display: inline-block;">
							@csrf
							@method('DELETE')
