          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="row">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data Halaman Kementerian Komunikasi dan Informatika</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="d-grid d-md-flex justify-content-md-end">
                      <a href="halaman/create" class="btn btn-sm fw-bold btn-primary me-2">
                        ...
                        Data Baru</a>
                      <a href="{{url('halaman-histori')}}" class="btn btn-sm fw-bold btn-danger">
                  ...
                  <div class="mt-3">
                    <div class="row">
                      ...
                      <div class="col-6 d-grid d-md-flex justify-content-md-end mb-3">
                        <form class="form" action="/halaman">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="align-middle">{{$halaman->judul}}</td>
                          <td class="align-middle">{{$halaman->createdDate()}}, {{$halaman->createdTime()}} WIB</td>
                          <td class="align-middle">{{$halaman->formatted_published_at}}, {{$halaman->publishedTime()}} WIB</td>
                          <td class="align-middle">
                            @if($halaman->status == 'published')
                            <p class="badge badge-success my-auto">Published</p>
                            @elseif($halaman->status == 'inactive')
                          ...
                          <td>
                          <a href="halaman/{{$halaman->id}}" class="btn btn-purple btn-sm" title="Detail" data-bs-toggle="tooltip">
                              <span>
                            ...
                            <a href="halaman/{{$halaman->id}}/edit" class="btn btn-yellow btn-sm" title="Ubah" data-bs-toggle="tooltip">
                              <span>
                            ...
                            <a href="#" class="btn btn-red btn-sm" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-halaman-id="{{ $halaman->id }}" title="Hapus">
                              <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                  <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                                </svg>
                ...
                <div class="mb-5">
                  {{$halamans->appends(['perPage' => $perPage])->links('pagination::bootstrap-5')}}
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirm-delete-modal-label">Hapus Halaman </h5>
          ...
          <div class="modal-body">Apakah kamu yakin ingin menghapus halaman ini ?</div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
            <form action="{{ url('halaman', '__halaman_id') }}" method="POST" style="display: inline-block;">
              @csrf
              @method('DELETE')
