...
@section('title','Data Histori Halaman')
@section('container')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Histori Halaman</h1>
        </div>
      </div>
    </div>
          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data Histori Halaman Kementerian Komunikasi dan Informatika</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div class="mt-3">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        @forelse ($halamanHistoris as $halamanHistori)
                        <tr>
                          <td class="align-middle">{{$loop->iteration}}</td>
                          <td class="align-middle">{{$halamanHistori->halaman->judul}}</td>
                          <td class="align-middle">{{$halamanHistori->halaman->deletedDate()}}, {{$halamanHistori->halaman->deletedTime()}} WIB</td>
                          <td class="align-middle">
                            @if($halamanHistori->halaman->status == 'published')
                            <p class="badge badge-success my-auto">Published</p>
                            @elseif($halamanHistori->halaman->status == 'inactive')
                          ...
                          <td>
                            <a href="halaman-histori/{{$halamanHistori->id}}" class="btn btn-purple btn-sm" title="Detail" data-bs-toggle="tooltip">
                              <span>
                            ...
                            <a href="halaman-restore/{{$halamanHistori->halaman_id}}" class="btn btn-green btn-sm" title="Pulihkan" data-bs-toggle="tooltip">
                              <span>
                ...
                <div class="mb-5">
                  {{$halamanHistoris->appends(['perPage' => $perPage])->links('pagination::bootstrap-5')}}
                </div>
              </div>
            </div>
          </div>
