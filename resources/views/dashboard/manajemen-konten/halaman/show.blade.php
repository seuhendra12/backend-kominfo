            ...
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold flex-column justify-content-center my-0">{{ $halaman -> judul }}</h1>
                  <span class="mt-2">www.kominfo.go.id - {{$halaman->createdDate()}}, {{$halaman->createdTime()}} WIB</span>
                </div>
                <div>
                  <div class="mt-3 mb-5">
                    <div>
                      <img src="{{ asset('media/gambar_cover/' . $halaman->gambar_cover) }}" alt="Gambar" width="500">
                    </div>
                    <table class="fw-bold">
                      <tr>
                        <td class="col-2">Penulis</td>
                        <td>:</td>
                        <td>{{$halaman->penulis}}</td>
                      </tr>
                      <tr>
                        <td>Status</td>
                        <td>:</td>
                      ...
                      <tr>
                        ...
                        <td>{!! htmlspecialchars_decode($halaman->isi_konten) !!}</td>
                      </tr>
                    </table>
                  </div>
                </div>
