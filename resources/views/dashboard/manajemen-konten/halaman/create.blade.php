                ...
                <div class="card card-flush h-md-100">
                  <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                    <div>
                      ...
                      @endforeach
                      @endif
                      <form class="form" action="{{url('halaman')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex flex-column mb-6 fv-row">
                          ...
                          <textarea name="isi_konten" id="isi_konten" cols="50" rows="10" class="form-control @error('isi_konten') is-invalid @enderror">{{old('isi_konten')}}</textarea>
                        </div>
                    </div>
                  </div>
                </div>
