                ...
                <div class="card card-flush h-md-100">
                  <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                    <div>
                      ...
                      @endforeach
                      @endif
                      <form class="form" action="{{url('konten')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Judul</span>
                          </label>
                          <input type="text" class="form-control @error('judul') is-invalid @enderror" placeholder="Tulis judul di sini. Contoh: Kominfo Blokir Ratusan Ribu Situs Judi Online" name="judul" value="{{old('judul')}}" />
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span>Judul Eng <span class="text-primary">(Optional)</span></span>
                          </label>
                          <input type="text" class="form-control @error('judul_eng') is-invalid @enderror" placeholder="Tulis judul bahasa inggris di sini" name="judul_eng" value="{{old('judul_eng')}}" />
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        ...
                        <div class="d-flex flex-column mb-6 fv-row">
                          ...
                          <input type="text" class="form-control @error('slug_eng') is-invalid @enderror" placeholder="Tulis slug bahasa inggris di sini." name="slug_eng" value="{{old('slug_eng')}}" />
                          <p class="fw-bold text-secondary">Slug bisa dikosongkan. Jika kosong akan dibuat otomatis dari judul.</p>
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                          ...
                          <textarea name="kutipan" id="" cols="20" rows="4" class="form-control @error('kutipan') is-invalid @enderror" placeholder="Tulis kutipan di sini.">{{old('kutipan')}}</textarea>
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span>Kutipan Eng <span class="text-primary">(Optional)</span></span>
                          </label>
                          <textarea name="kutipan_eng" id="" cols="20" rows="4" class="form-control @error('kutipan_eng') is-invalid @enderror" placeholder="Tulis kutipan bahasa inggris di sini.">{{old('kutipan_eng')}}</textarea>
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Isi Konten</span>
                          </label>
                          <textarea name="isi_konten" id="isi_konten" cols="20" rows="4" class="form-control @error('isi_konten') is-invalid @enderror">{{old('isi_konten')}}</textarea>
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span>Isi Konten Eng<span class="text-primary">(Optional)</span></span>
                          </label>
                          <textarea name="isi_konten_eng" id="isi_konten_eng" cols="20" rows="4" class="form-control @error('isi_konten_eng') is-invalid @enderror">{{old('isi_konten_eng')}}</textarea>
                        </div>
                        <div class="d-flex flex-column mb-6 fv-row">
                        ...
                        <div class="d-flex flex-column mb-6 fv-row">
                          ...
                          <input type="file" class="form-control @error('lampiran') is-invalid @enderror" placeholder="Pilih file" name="files[]" value="{{old('lampiran')}}" multiple required />
                  ...
                  <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                    <div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <div class="d-flex flex-column mb-6 fv-row">
                            <input type="date" class="form-control @error('tanggal_terbit') is-invalid @enderror" name="tanggal_terbit" value="{{old('tanggal_terbit')}}" />
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="d-flex flex-column mb-6 fv-row">
                            <input type="time" class="form-control @error('jam_terbit') is-invalid @enderror" name="jam_terbit" value="{{old('jam_terbit')}}" />
                          </div>
                        </div>
                      </div>
                      <div class="d-flex flex-column mb-6 fv-row">
                        ...
                        <div class="col-lg-8">
                          <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Upload gambar">
                              ...
                              <input type="file" name="gambar_cover" accept=".png, .jpg, .jpeg" value="{{old('gambar_cover')}}" class="@error('gambar_cover') is-invalid @enderror" required />
                            </label>
                      ...
                      <div class="d-flex flex-column mb-6 fv-row">
                        ...
                        <div class="col-lg-8">
                          <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Upload gambar">
                              <i class="bi bi-pencil-fill fs-7"></i>
                              <input type="file" name="gambar_slider" accept=".png, .jpg, .jpeg" value="{{old('gambar_slider')}}" class="@error('gambar_slider') is-invalid @enderror" required />
                            </label>
                            <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Batal gambar">
                              <i class="bi bi-x fs-2"></i>
                            </span>
                      ...
                      <div class="mb-6">
                        ...
                        <label class="form-check form-switch form-check-custom form-check-solid">
                          <input name="featured" class="form-check-input" type="checkbox" value="1" />
                        </label>
                      </div>
                      <div class="mb-6">
                        ...
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"></i>
                        <label class="form-check form-switch form-check-custom form-check-solid">
                          <input name="featured_eng" class="form-check-input" type="checkbox" value="1" />
                        </label>
                      </div>
                      <div class="mb-6">
                        ...
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"></i>
                        <label class="form-check form-switch form-check-custom form-check-solid">
                          <input name="sticky" class="form-check-input" type="checkbox" value="1" />
                        </label>
                      </div>
                      <div class="mb-6">
                        ...
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"></i>
                        <label class="form-check form-switch form-check-custom form-check-solid">
                          <input name="sticky_eng" class="form-check-input" type="checkbox" value="1" />
                        </label>
                      </div>
                      <div class="mb-6">
                        ...
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"></i>
                        <label class="form-check form-switch form-check-custom form-check-solid">
                          <input name="is_gpr" class="form-check-input" type="checkbox" value="1" />
                        </label>
                      </div>
                      <div class="mb-10">
