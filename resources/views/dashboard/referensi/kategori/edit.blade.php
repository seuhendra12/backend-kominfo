						...
						<div class="card card-flush h-md-100">
							<div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
								...
								<div>
									...
									@endforeach
									@endif
									<form class="form" action="/kategoris/{{$kategoris->id}}" method="POST">
										@csrf
										@method('PUT')
										<div class="d-flex flex-column mb-8 fv-row">
											...
											<input type="text" class="form-control" placeholder="Masukkan Nama Kategori" name="name" value="{{old('name',$kategoris->name)}}" />
										</div>
										<div class="mb-10">
